...
bodyValue=$(
	cat <<-EOM
		...
		# Note
		For tasks that don\'t have a specific script, i.e. tasks 1, 3, 5, 6, 8, and 11, run \`./bom-release-issue-complete-task.sh <task number>\` to check the box off without having to manually edit the issue.
